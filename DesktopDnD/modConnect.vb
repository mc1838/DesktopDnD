Module modConnect
    ...
    Public strConnect2 As String = "Data Source=csc450.database.windows.net;Initial Catalog=GameDB;Persist Security Info=True;User ID=mc1838;Password=Project450"
    ...
    Public Function SQLSelect(ByVal SQLqry As String) As DataSet
        ...
        commandText = SQLqry
        connection.ConnectionString = strConnect2
